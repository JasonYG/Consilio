...
var URLS = require("./constants/urls.json");
const io = require("socket.io-client");
const API_BASE_URL = URLS.API_BASE_URL;
const socket = io(API_BASE_URL);

var hackerModeGetAuthToken = require("./src/lib/requests/hackerModeGetAuthToken.js");
...
module.exports.fingerIsMoving = function (finger) {
...
module.exports.prepareFrame = frame => {
...
module.exports.frameNotValid = function(frame) {
...
module.exports.palmMoving = function(palmVelocity) {
...
module.exports.gestureHasEnoughFrames = function(framesInGesture) {
